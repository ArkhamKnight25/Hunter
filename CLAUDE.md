...
This project is indexed by GitNexus as **Hunter** (754 symbols, 1288 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Hunter/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Hunter/clusters` | All functional areas |
| `gitnexus://repo/Hunter/processes` | All execution flows |
| `gitnexus://repo/Hunter/process/{name}` | Step-by-step execution trace |
